...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    rightMaster.set(ControlMode.PercentOutput, (driveControl.getY() - driveControl.getX()));
    leftMaster.set(ControlMode.PercentOutput, (driveControl.getY() + driveControl.getX()));
  }
